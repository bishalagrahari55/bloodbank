...
$pages = str_ireplace("http://localhost:81/gks/admin/", "", $page);
            ...
            <div class="row collapsible">
                ...
                if (isset($_POST['update'])) {
                    ...
                    if (empty($uname)) {
                        ...
                        $update_query = mysqli_query($connection, "UPDATE users SET UserName = '$uname', Email = '$uemail', Role = '$urole', Age = '$uage', Address = '$uaddress', Gender = '$ugender', BloodGroup = '$ubgroup',  MobileNumber = '$umobile', Message = '$umessage', DonorImage = '$image' WHERE UID = '$uid'") or die(print_r(mysqli_error_list($connection)));
                            ...
                            <form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="address" class="form-control" id="address"  placeholder="About Me"><?php echo $address; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="activity">
                                <?php
                                $sql = mysqli_query($connection, "select * from system_log order by LogDate ASC Limit 0,5");
                                while ($row = mysqli_fetch_array($sql)) {
                                    ...
                                    <div class="post">
                                        ...
                                        <!-- /.user-block -->
                                        <p>
                                            <?php echo "<b class=' text-center'>".ucfirst($row['UserName'])." ". $row['Description']."</b><hr>"?>
                                        </p>
